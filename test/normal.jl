...
using Test
using TreeParzen
const Observations = TreeParzen.ConstrainedVectors.Observations
...
@testset "Samplers.normal" begin
    ...
    @testset "empty observations, prior-only mixture" begin
        ...
        sigma = 1.0
        n = 10_000
        post, mixture = TreeParzen.Samplers.normal(Observations(), mu, sigma, n, config)
